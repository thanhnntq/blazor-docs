...
The columns of the Grid are one of its main building blocks and offer a wide range of built-in functionalities. These are some of the key column features:
...
* [Loading animation]({%slug components/grid/loading-animation%})&mdash;The Blazor Data Grid provides a loading animation that improves the user experience by indicating an ongoing data operation, for example, paging, grouping and others.
